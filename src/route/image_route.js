...
// upload a new image
router.route('/image/new/:userId').post(user_controller.require_signin, user_controller.is_account, image_controller.create_image)

// get all images of an user
router.route('/image/:userId').get(user_controller.require_signin, user_controller.is_author, image_controller.list_by_user)
